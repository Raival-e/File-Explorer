...
public interface CSSStyleDeclaration {
     ...
     * of properties.
     *
     * @throws DOMException SYNTAX_ERR: Raised if the specified CSS string value has a syntax
     ...
     * @throws DOMException SYNTAX_ERR: Raised if the specified value has a syntax error and is
     *                      unparsable.
     *                      <br>NO_MODIFICATION_ALLOWED_ERR: Raised if this declaration is
