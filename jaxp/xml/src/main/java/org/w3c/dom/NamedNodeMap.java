...
public interface NamedNodeMap {
     ...
     * is returned.
     * @throws org.w3c.dom.DOMException WRONG_DOCUMENT_ERR: Raised if <code>arg</code> was created from a
     ...
     * exists.
     * @throws org.w3c.dom.DOMException NOT_FOUND_ERR: Raised if there is no node named <code>name</code> in
     *                                  this map.
     *                                  <br>NO_MODIFICATION_ALLOWED_ERR: Raised if this map is readonly.
     */
     ...
     * @throws org.w3c.dom.DOMException NOT_FOUND_ERR: Raised if there is no node with the specified
