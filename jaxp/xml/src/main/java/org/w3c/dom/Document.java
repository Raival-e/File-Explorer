...
public interface Document extends org.w3c.dom.Node {
     ...
     * @throws org.w3c.dom.DOMException INVALID_CHARACTER_ERR: Raised if the specified target is not an XML
     *                                  name according to the XML version in use specified in the
     *                                  <code>Document.xmlVersion</code> attribute.
     ...
     * @throws org.w3c.dom.DOMException NOT_SUPPORTED_ERR: Raised if the type of node being imported is not
     *                                  supported.
     ...
     * </tr>
     * </table>
     * @throws org.w3c.dom.DOMException INVALID_CHARACTER_ERR: Raised if the specified
     ...
     * @since DOM Level 3
     */
    public org.w3c.dom.Node renameNode(Node n,
                                       String namespaceURI,
                                       String qualifiedName)
            throws DOMException;
