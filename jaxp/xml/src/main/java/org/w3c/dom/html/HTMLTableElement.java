...
public interface HTMLTableElement extends HTMLElement {
     ...
     * @throws DOMException INDEX_SIZE_ERR: Raised if the specified index is greater than the
     ...
     * @throws DOMException INDEX_SIZE_ERR: Raised if the specified index is greater than or
