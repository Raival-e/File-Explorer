...
public interface CSSStyleSheet extends StyleSheet {
     ...
     * newly inserted rule.
     * @throws DOMException HIERARCHY_REQUEST_ERR: Raised if the rule cannot be inserted at the
     ...
     * @param index The index within the style sheet's rule list of the rule
     *              to remove.
     * @throws DOMException INDEX_SIZE_ERR: Raised if the specified index does not correspond to
