 ...
 *
 * <p>
 * A {@link Schema} object is usually created from {@link org.openjdk.javax.xml.validation.SchemaFactory}.
 *
 * <p>
 * Two kinds of validators can be created from a {@link Schema} object.
 * One is {@link org.openjdk.javax.xml.validation.Validator}, which provides highly-level validation
 * operations that cover typical use cases. The other is
 * {@link org.openjdk.javax.xml.validation.ValidatorHandler}, which works on top of SAX for better
 * modularity.
 *
 * <p>
...
public abstract class Schema {
     ...
     * {@link org.openjdk.javax.xml.validation.SchemaFactory} that created this {@link Schema} are also
     * set on the {@link org.openjdk.javax.xml.validation.Validator} constructed.</p>
     *
    ...
    /**
     * Creates a new {@link org.openjdk.javax.xml.validation.ValidatorHandler} for this {@link Schema}.
     *
     * <p>Implementors should assure that the properties set on the
     * {@link SchemaFactory} that created this {@link Schema} are also
     * set on the {@link org.openjdk.javax.xml.validation.ValidatorHandler} constructed.</p>
     *
     * @return Always return a non-null valid object.
     */
