 ...
 * {@link org.openjdk.javax.xml.xpath.XPath} objects.</p>
 *
...
public abstract class XPathFactory {
    ...
    public static XPathFactory newInstance() {
        ...
        } catch (org.openjdk.javax.xml.xpath.XPathFactoryConfigurationException xpathFactoryConfigurationException) {
     ...
     *     {@link org.openjdk.javax.xml.xpath.XPathFactoryConfigurationException} will be thrown.
     *   </li>
     *   <li>
     ...
     * @return Instance of an <code>XPathFactory</code>.
     * @throws org.openjdk.javax.xml.xpath.XPathFactoryConfigurationException If the specified object model
     ...
     * @throws org.openjdk.javax.xml.xpath.XPathFactoryConfigurationException if <code>factoryClassName</code> is <code>null</code>, or
    ...
    public static XPathFactory newInstance(String uri, String factoryClassName, ClassLoader classLoader)
        ...
        if (f.isObjectModelSupported(uri)) {
            ...
            throw new org.openjdk.javax.xml.xpath.XPathFactoryConfigurationException("Factory "
     ...
     * An {@link org.openjdk.javax.xml.xpath.XPathFactoryConfigurationException} is thrown if this
     ...
     * Under these conditions, the implementation must not call the {@link org.openjdk.javax.xml.xpath.XPathFunctionResolver}
     * and must throw an {@link XPathFunctionException}.
     * </p>
     *
     * @param name  Feature name.
     * @param value Is feature state <code>true</code> or <code>false</code>.
     * @throws org.openjdk.javax.xml.xpath.XPathFactoryConfigurationException if this <code>XPathFactory</code> or the <code>XPath</code>s
     ...
     * @throws org.openjdk.javax.xml.xpath.XPathFactoryConfigurationException if this
     *                                                                        <code>XPathFactory</code> or the <code>XPath</code>s
     *                                                                        it creates cannot support this feature.
     * @throws NullPointerException                                           if <code>name</code> is <code>null</code>.
     */
