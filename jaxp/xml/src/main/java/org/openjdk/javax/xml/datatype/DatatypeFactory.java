 ...
 *      Any Exception thrown during the instantiation process is wrapped as a {@link org.openjdk.javax.xml.datatype.DatatypeConfigurationException}.
 *    </li>
 *    <li>
 ...
 *     configuration error} a {@link org.openjdk.javax.xml.datatype.DatatypeConfigurationException}
 *     will be thrown.
 *    </li>
 *    <li>
...
public abstract class DatatypeFactory {
     ...
     * @throws org.openjdk.javax.xml.datatype.DatatypeConfigurationException If the implementation is not
     ...
     * @return New instance of a <code>DatatypeFactory</code>
     * @throws org.openjdk.javax.xml.datatype.DatatypeConfigurationException if <code>factoryClassName</code> is <code>null</code>, or
     ...
     * </blockquote>
     * <p>All six values are set and available from the created {@link org.openjdk.javax.xml.datatype.Duration}</p>
     *
     ...
     */
    public abstract org.openjdk.javax.xml.datatype.Duration newDuration(final String lexicalRepresentation);
     ...
     * and are available using the <code>get</code> methods of  the created {@link org.openjdk.javax.xml.datatype.Duration}.
     ...
     *   </li>
     *   <li>{@link org.openjdk.javax.xml.datatype.XMLGregorianCalendar}  Date/Time Datatype Field Mapping Between XML Schema 1.0 and Java Representation</li>
     * </ul>
     *
     ...
     * so the result of {@link org.openjdk.javax.xml.datatype.Duration#getMonths()} and {@link org.openjdk.javax.xml.datatype.Duration#getDays()} can be influenced.</p>
     *
     ...
     */
    public abstract org.openjdk.javax.xml.datatype.Duration newDuration(final long durationInMilliSeconds);
     ...
     * specifying the <code>Duration</code> as isPositive, years, months, days, hours, minutes, seconds.</p>
     *
     * <p>A {@link org.openjdk.javax.xml.datatype.DatatypeConstants#FIELD_UNDEFINED} value indicates that field is not set.</p>
     *
     * @param isPositive Set to <code>false</code> to create a negative duration. When the length
     *                   of the duration is zero, this parameter will be ignored.
     * @param years      of this <code>Duration</code>
    ...
    public org.openjdk.javax.xml.datatype.Duration newDuration(
        ...
        BigInteger realYears = (years != org.openjdk.javax.xml.datatype.DatatypeConstants.FIELD_UNDEFINED) ? BigInteger.valueOf((long) years) : null;

        // months may not be set
        BigInteger realMonths = (months != org.openjdk.javax.xml.datatype.DatatypeConstants.FIELD_UNDEFINED) ? BigInteger.valueOf((long) months) : null;

        // days may not be set
        BigInteger realDays = (days != org.openjdk.javax.xml.datatype.DatatypeConstants.FIELD_UNDEFINED) ? BigInteger.valueOf((long) days) : null;

        // hours may not be set
        BigInteger realHours = (hours != org.openjdk.javax.xml.datatype.DatatypeConstants.FIELD_UNDEFINED) ? BigInteger.valueOf((long) hours) : null;

        // minutes may not be set
        BigInteger realMinutes = (minutes != org.openjdk.javax.xml.datatype.DatatypeConstants.FIELD_UNDEFINED) ? BigInteger.valueOf((long) minutes) : null;

        // seconds may not be set
        BigDecimal realSeconds = (seconds != org.openjdk.javax.xml.datatype.DatatypeConstants.FIELD_UNDEFINED) ? BigDecimal.valueOf((long) seconds) : null;
     ...
     *
     * <p>All four values are set and available from the created {@link org.openjdk.javax.xml.datatype.Duration}</p>
     *
     * <p>The XML Schema specification states that values can be of an arbitrary size.
     * Implementations may chose not to or be incapable of supporting arbitrarily large and/or small values.
     * An {@link UnsupportedOperationException} will be thrown with a message indicating implementation limits
     ...
     * @throws NullPointerException          If <code>lexicalRepresentation</code> is <code>null</code>.
     */
    public org.openjdk.javax.xml.datatype.Duration newDurationDayTime(final String lexicalRepresentation) {
     ...
     * This is important as there are variations in the Gregorian Calendar,
     * e.g. leap years have different days in the month = {@link java.util.Calendar#FEBRUARY}
     * so the result of {@link org.openjdk.javax.xml.datatype.Duration#getDays()} can be influenced.</p>
     *
     ...
     */
    public org.openjdk.javax.xml.datatype.Duration newDurationDayTime(final long durationInMilliseconds) {
     ...
     *
     * <p>Both values are set and available from the created {@link org.openjdk.javax.xml.datatype.Duration}</p>
     *
     * <p>The XML Schema specification states that values can be of an arbitrary size.
     * Implementations may chose not to or be incapable of supporting arbitrarily large and/or small values.
     * An {@link UnsupportedOperationException} will be thrown with a message indicating implementation limits
     ...
     * This is important as there are variations in the Gregorian Calendar,
     * e.g. leap years have different days in the month = {@link java.util.Calendar#FEBRUARY}
     * so the result of {@link org.openjdk.javax.xml.datatype.Duration#getMonths()} can be influenced.</p>
     *
    ...
    public org.openjdk.javax.xml.datatype.Duration newDurationYearMonth(
        ...
        BigInteger years =
                (BigInteger) fullDuration.getField(org.openjdk.javax.xml.datatype.DatatypeConstants.YEARS);
        if (years == null) {
            years = BigInteger.ZERO;
        }
        BigInteger months =
                (BigInteger) fullDuration.getField(org.openjdk.javax.xml.datatype.DatatypeConstants.MONTHS);
        if (months == null) {
     ...
     *
     * <p>All date/time datatype fields set to {@link org.openjdk.javax.xml.datatype.DatatypeConstants#FIELD_UNDEFINED} or null.</p>
     *
     ...
     * @throws NullPointerException     If <code>lexicalRepresentation</code> is <code>null</code>.
     */
    public abstract org.openjdk.javax.xml.datatype.XMLGregorianCalendar newXMLGregorianCalendar(final String lexicalRepresentation);
     ...
     */
    public abstract org.openjdk.javax.xml.datatype.XMLGregorianCalendar newXMLGregorianCalendar(final GregorianCalendar cal);
     ...
     *                                  as determined by the Date/Time Data Mapping table in {@link org.openjdk.javax.xml.datatype.XMLGregorianCalendar}
     *                                  or if the composite values constitute an invalid <code>XMLGregorianCalendar</code> instance
     *                                  as determined by {@link org.openjdk.javax.xml.datatype.XMLGregorianCalendar#isValid()}.
     */
    public abstract org.openjdk.javax.xml.datatype.XMLGregorianCalendar newXMLGregorianCalendar(
            final BigInteger year,
            final int month,
    ...
    public org.openjdk.javax.xml.datatype.XMLGregorianCalendar newXMLGregorianCalendar(
        ...
        BigInteger realYear = (year != org.openjdk.javax.xml.datatype.DatatypeConstants.FIELD_UNDEFINED) ? BigInteger.valueOf((long) year) : null;
     ...
     * {@link org.openjdk.javax.xml.datatype.DatatypeConstants#FIELD_UNDEFINED}.</p>
     *
     * <p>A {@link org.openjdk.javax.xml.datatype.DatatypeConstants#FIELD_UNDEFINED} value indicates that field is not set.</p>
     *
     * @param year     of <code>XMLGregorianCalendar</code> to be created.
     * @param month    of <code>XMLGregorianCalendar</code> to be created.
     * @param day      of <code>XMLGregorianCalendar</code> to be created.
     * @param timezone offset in minutes. {@link org.openjdk.javax.xml.datatype.DatatypeConstants#FIELD_UNDEFINED} indicates optional field is not set.
