...
public class DOMUtil {
    ...
    public static void setHidden(Node node) {
        if (node instanceof org.openjdk.com.sun.org.apache.xerces.internal.impl.xs.opti.NodeImpl)
            ((org.openjdk.com.sun.org.apache.xerces.internal.impl.xs.opti.NodeImpl) node).setReadOnly(true, false);
    ...
    public static void setVisible(Node node) {
        if (node instanceof org.openjdk.com.sun.org.apache.xerces.internal.impl.xs.opti.NodeImpl)
            ((org.openjdk.com.sun.org.apache.xerces.internal.impl.xs.opti.NodeImpl) node).setReadOnly(false, false);
        else if (node instanceof NodeImpl)
    ...
    public static boolean isHidden(Node node) {
        if (node instanceof org.openjdk.com.sun.org.apache.xerces.internal.impl.xs.opti.NodeImpl)
            return ((org.openjdk.com.sun.org.apache.xerces.internal.impl.xs.opti.NodeImpl) node).getReadOnly();
        else if (node instanceof NodeImpl)
